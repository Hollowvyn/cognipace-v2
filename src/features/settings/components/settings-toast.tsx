...
export const SETTINGS_TOAST_AUTO_HIDE_MS = 3500
...
export function SettingsToast({ status }: SettingsToastProps) {
  const [dismissedStatus, setDismissedStatus] =
    useState<SettingsDraftStatus>(null)
  ...
  return (
    ...
    >
      ...
      <button
        aria-label="Dismiss settings feedback"
