...
- [`plans/2026-05-31-auto-gist-sync.md`](./plans/2026-05-31-auto-gist-sync.md): implementation plan for alarm-backed automatic safe Gist sync, clean open checks, retry policy, and scheduler foundations.
