...
- [`specs/2026-06-14-genai-byok-sdk-rebuild-design.md`](./specs/2026-06-14-genai-byok-sdk-rebuild-design.md): design for rebuilding GenAI BYOK provider setup as a Data Management connection workflow, separating Auto assessment and AI assessment from provider/model/key state, and moving provider calls behind Vercel AI SDK Core in trusted background code.
